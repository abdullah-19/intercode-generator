						...
						if (!var.empty()) {
							...
							*/
							...
							JUST_EXCUATE:
								...
								*/
								code.push_back(WString::Concat(L"$t", count, L"_=") + WString::Concat(var.top(), str, temp));
								var.pop();
								var.push(WString::Concat(L"$t", count, L"_"));
								count += 1;
							}
						}
						else
						...
						*/
						...
						if (!t) {
							...
							*/
							...
							code.push_back(WString::Concat(L"$t", count, "_=", str));
							count += 1;
						}
					}
				}
